...
namespace SmarterBalanced.SampleItems.Test.DalTests.TranslationsTests
{
    public class AccessibilityTranslationTests
    {
        ...
        public void TestApplyAslFlag()
        {
            ...
            var resModified = resource.ApplyFlags(itemDigest, "", false, new List<string>(), new List<string>(), null);
        ...
        public void TestDoNotDisableDictionary()
        {
            ...
            var resModified = resource.ApplyFlags(itemDigest, "WER", false, new List<string> { "WER" }, new List<string>(), null);
        ...
        public void TestDisableDictionary()
        {
            ...
            var resModified = resource.ApplyFlags(itemDigest, itemType, false, new List<string> { "WER" }, new List<string>(), null);
        ...
        public void TestDisableGlobalNotes()
        {
            ...
            var resModified = resource.ApplyFlags(itemDigest, itemType, false, new List<string> { "MC" }, new List<string>(), null);
        ...
        public void TestEnableGlobalNotes()
        {
            ...
            var resModified = resource.ApplyFlags(itemDigest, itemType, true, new List<string> { "MC" }, new List<string>(), null);
